...
class MD5State {
   ...
   */
     ...
     */
    public MD5State() {
        buffer = new byte[64]; // SUPPRESS CHECKSTYLE
        count = 0;
        state = new int[4]; // SUPPRESS CHECKSTYLE
        state[0] = 0x67452301; // SUPPRESS CHECKSTYLE
        state[1] = 0xefcdab89; // SUPPRESS CHECKSTYLE
        state[2] = 0x98badcfe; // SUPPRESS CHECKSTYLE
        state[3] = 0x10325476; // SUPPRESS CHECKSTYLE
    }
    /**
